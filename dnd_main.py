...
def printChar():                        # The pretty part, this prints everything out and adds the class to the class list to ensure no duplicates
    ...
    flask.flash("Alignment: " + align)
    flask.flash("Race: " + race2)
    flask.flash("Class: " + clas)
